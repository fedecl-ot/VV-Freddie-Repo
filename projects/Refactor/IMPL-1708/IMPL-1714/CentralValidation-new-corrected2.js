...
const hardCode = true; //by convention the VV.Form.Global.SetupReg() must be called inside a conditional so it is neccessary to hardcode the condition to always be true
if (hardCode) {
