...
Revision Notes:
                ...
                06/07/2022 - Franco Petosa Ayala:   Update to ES6
                                                    Change the declaration of the variable "dialogStyle" using const instead of let
                                                    Change the declaration of the variable "confirmDialog" using const instead of let
                                                    Change the declaration of the variable "overlay" using const instead of let
